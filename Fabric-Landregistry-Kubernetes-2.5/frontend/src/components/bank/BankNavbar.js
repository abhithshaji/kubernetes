        ...
        <Container>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="me-auto sro-navbar-text">
              <Nav.Link href="/bankSearchLand" className="sro-navbar-text">
                Search Land
              </Nav.Link>

              <Nav.Link href="/bankMortgage" className="sro-navbar-text">
                Land Mortgage
              </Nav.Link>
            </Nav>
            <Nav className="sro-navbar-text2">Bank - {page}</Nav>
            <Nav>
